package com.shell.xyxv1.core.entity.vo;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.shell.xyxv1.core.exception.BaseException;
import com.shell.xyxv1.core.exception.ErrorType;
import com.shell.xyxv1.core.exception.SystemErrorType;
...
public class Result<T> {
    ...
    private Result(ErrorType errorType, String message, T data) {
    ...
    private Result(ErrorType errorType, String mesg) {
        this.code = errorType.getCode();
        this.mesg = mesg;
        this.time = ZonedDateTime.now().toInstant();
    }
